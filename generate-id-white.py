...
def create_qr_code_with_logo(
    ...
    if top_image_path:
        ...
        top_image_with_bg = Image.new(
            "RGBA", (width, scaled_height), (255, 255, 255, 255)
        )
        offset_x = (width - scaled_width) // 2
        top_image_with_bg.paste(top_image, (offset_x, 0), top_image)
    else:
        top_image_with_bg = Image.new(
            "RGBA", (width, int(width * top_image_scale)), (255, 255, 255, 255)
        )

    padding_area = Image.new("RGBA", (width, extra_padding), (255, 255, 255, 255))

    combined_height = height + top_image_with_bg.height + extra_padding
    combined_img = Image.new("RGBA", (width, combined_height), (255, 255, 255, 255))
...
logo_path = "./assets/new-kuru-1.png"
top_image_path = "./assets/kuru-black.png"
qr_img = create_qr_code_with_logo(url, logo_path, top_image_path, top_image_scale=0.85)
qr_img.save("./Id-cards/white-id-card.png")
